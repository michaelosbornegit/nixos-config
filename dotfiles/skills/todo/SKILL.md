...
- **project-name**: Derived from the current working directory's folder name (e.g., if working in `~/development/repos/my_project`, use `my-project`)
...
- Example: `my-project--add-managed-identity-to-sql.md`
